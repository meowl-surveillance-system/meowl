...
app.get(
  ...
  isLoggedIn,
  async (req: express.Request, res: express.Response) => {
    apiController.retrieveUserGroups(req, res);
  }
);
...
app.get(
  ...
  isLoggedIn,
  async (req: express.Request, res: express.Response) => {
    apiController.retrieveGroupUsers(req, res);
  }
);
...
app.get(
  ...
  [isLoggedIn, isAdmin],
  async (req: express.Request, res: express.Response) => {
    apiController.retrieveGroupCameras(req, res);
  }
);
...
app.get(
  ...
  isLoggedIn,
  async (req: express.Request, res: express.Response) => {
    apiController.retrieveUserGroupCameras(req, res);
  }
);
...
app.get(
  ...
  isLoggedIn,
  async (req: express.Request, res: express.Response) => {
    apiController.retrieveLiveGroupCameraStreamIds(req, res);
  }
);
